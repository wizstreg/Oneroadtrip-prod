/**
 * OneRoadTrip - Fichier I18N centralisé
 * 6 langues : fr, en, es, it, pt, ar
 * Utilisé par roadtrip_detail.html et roadtrip_detail_simple.html
 */

window.ORT_I18N = {
  // ═══════════════════════════════════════════════════════════════
  // MENU OUTILS - AFFICHAGE
  // ═══════════════════════════════════════════════════════════════
  unit: {
    fr: 'Unité',
    en: 'Unit',
  ...
  recalculateNights: {
    ...
    en: 'Recalculate nights',
    es: 'Recalcular noches',
  ...
  cancelGroups: {
    ...
    en: 'Cancel groups (manual mode)',
    es: 'Cancelar grupos (modo manual)',
  ...
  accommodationMap: {
    ...
    en: 'Accommodation map',
    es: 'Mapa de alojamientos',
    it: 'Mappa alloggi',
  ...
  generatePdf: {
    ...
    en: 'Generate a PDF of the roadtrip',
    es: 'Generar un PDF del viaje',
  ...
  estimatedTime: {
    ...
    en: 'Estimated visit time',
    es: 'Tiempo de visita estimado',
  ...
  exportJsonDesc: {
    ...
    en: 'Native OneRoadTrip format. Can be reimported into the app.',
    es: 'Formato nativo OneRoadTrip. Se puede reimportar en la aplicación.',
  ...
  exportGpxDesc: {
    ...
    en: 'GPS compatible (Garmin, TomTom), hiking apps (Komoot, AllTrails), Google Earth.',
    es: 'Compatible GPS (Garmin, TomTom), apps de senderismo (Komoot, AllTrails), Google Earth.',
  ...
  exportKmlDesc: {
    ...
    en: 'For Google Earth and Google Maps (import to "My Places").',
    es: 'Para Google Earth y Google Maps (importar en "Mis sitios").',
  ...
  dashboardAccess: {
    ...
    en: 'You must be registered to access the Dashboard.',
    es: 'Debe estar registrado para acceder al Dashboard.',
  ...
  nightsTooltip: {
    ...
    en: 'Set number of nights (0 = just passing through)',
    es: 'Definir número de noches (0 = solo de paso)',
  ...
  // ═══════════════════════════════════════════════════════════════
  // PANNEAU DÉTAILS (activités, visites)
  // ═══════════════════════════════════════════════════════════════
  plannedVisits: {
    fr: 'Visites prévues',
    en: 'Planned visits',
    es: 'Visitas previstas',
    it: 'Visite previste',
  ...
  noVisits: {
    ...
    en: 'No visits planned',
    es: 'Sin visitas previstas',
  ...
  // ═══════════════════════════════════════════════════════════════
  proposePhoto: {
    fr: 'Proposer une photo libre de droit',
    en: 'Suggest a royalty-free photo',
    es: 'Proponer una foto libre de derechos',
  ...
  reportError: {
    ...
    en: 'Report an error on this place',
    es: 'Reportar un error en este lugar',
  ...
  bookActivity: {
    ...
    en: 'Book an activity (coming soon)',
    es: 'Reservar una actividad (próximamente)',
  ...
  bookGuide: {
    ...
    en: 'Book a guide (coming soon)',
    es: 'Reservar un guía (próximamente)',
  ...
  saveRoadtrip: {
    ...
    en: 'Save this road trip',
    es: 'Guardar este road trip',
  ...
  rateRoadtrip: {
    ...
    en: 'Rate this road trip',
    es: 'Valorar este road trip',
  ...
  addFeedback: {
    ...
    es: 'Añade un comentario útil para otros viajeros…',
  ...
  thankYouRating: {
    ...
    en: '✅ Thank you! Your rating has been recorded.',
    es: '✅ ¡Gracias! Tu valoración ha sido registrada.',
  ...
  reportRTError: {
    ...
    en: 'Report an RT or an error',
    es: 'Reportar un RT o un error',
  ...
  editMapRoute: {
    ...
    en: 'Edit route on map',
    es: 'Editar el itinerario en el mapa',
  ...
  reactivateAutoCalc: {
    ...
    en: 'Reactivate automatic calculation',
    es: 'Reactivar el cálculo automático',
  ...
  fullscreenList: {
    ...
    en: 'Fullscreen list (2 columns)',
    es: 'Lista en pantalla completa (2 columnas)',
  ...
  reorganize: {
    ...
    en: 'Reorganize itinerary',
    es: 'Reorganizar el itinerario',
  ...
  removeReintegrate: {
    ...
    en: 'Remove / Reintegrate',
    es: 'Eliminar / Reintegrar',
  ...
  // ═══════════════════════════════════════════════════════════════
  legend: {
    fr: 'Survolez pour la légende',
    en: 'Hover for legend',
    es: 'Pase el ratón para la leyenda',
  ...
  travelDaysNote: {
    ...
    en: 'Flight (+1d if ≥600km) · Long drive (+0.5d if ≥5h)',
    es: 'Vuelo (+1d si ≥600km) · Ruta larga (+0.5d si ≥5h)',
  ...
  hotelStrategy: {
    ...
    en: 'Change hotel grouping strategy (5 modes)',
    es: 'Cambiar la estrategia de agrupación de hoteles (5 modos)',
  ...
  startDate: {
    ...
    en: 'Itinerary start date',
    es: 'Fecha de inicio del itinerario',
  ...
  writeToSource: {
    ...
    en: 'Write changes to source JSON file',
    es: 'Escribir los cambios en el archivo JSON fuente',
  ...
  noModeAvailable: {
    ...
    en: 'No mode available',
    es: 'Ningún modo disponible',
  ...
  // ═══════════════════════════════════════════════════════════════
  // AFFILIÉS - ACTIVITÉS (GetYourGuide)
  // ═══════════════════════════════════════════════════════════════
  bookActivities: {
    fr: 'Réserver des activités',
    en: 'Book activities',
    es: 'Reservar actividades',
    it: 'Prenota attività',
  ...
  poweredByGyg: {
    ...
    en: 'Powered by GetYourGuide',
    es: 'Ofrecido por GetYourGuide',
  ...
  noActivitiesFound: {
    ...
    en: 'No activities found for this location',
    es: 'No se encontraron actividades para este lugar',
...
/**
 * Pluraliser nuit/nuits
 * @param {number} n - Nombre
 * @returns {string} "X nuit" ou "X nuits"
 */
window.tNights = function(n) {
  const lang = window.ORT_getLang();
  const word = n > 1 ? window.ORT_I18N.nights[lang] : window.ORT_I18N.night[lang];
  return `${n} ${word || (n > 1 ? 'nights' : 'night')}`;
};

/**
 * Pluraliser jour/jours
 * @param {number} n - Nombre
 * @returns {string} "X jour" ou "X jours"
 */
window.tDays = function(n) {
  const lang = window.ORT_getLang();
  const word = n > 1 ? window.ORT_I18N.days[lang] : window.ORT_I18N.day[lang];
  return `${n} ${word || (n > 1 ? 'days' : 'day')}`;
};
...
window.applyI18N = function() {
  ...
  document.querySelectorAll('[data-i18n]').forEach(el => {
    ...
    if (window.ORT_I18N[key]?.[lang]) {
      el.textContent = window.ORT_I18N[key][lang];
    }
  });
  document.querySelectorAll('[data-i18n-title]').forEach(el => {
    const key = el.dataset.i18nTitle;
    if (window.ORT_I18N[key]?.[lang]) {
      el.title = window.ORT_I18N[key][lang];
    }
  });
  document.querySelectorAll('[data-i18n-placeholder]').forEach(el => {
    const key = el.dataset.i18nPlaceholder;
    if (window.ORT_I18N[key]?.[lang]) {
      el.placeholder = window.ORT_I18N[key][lang];
    }
  });
};
...
// ═══════════════════════════════════════════════════════════════
// MODAL PARTENAIRE - REDIRECTION
// ═══════════════════════════════════════════════════════════════
window.ORT_I18N.partnerRedirectTitle = {
...
window.ORT_I18N.partnerVehicleText = {
  ...
  es: '¿Qué estás buscando para tu viaje?',
...
window.ORT_I18N.partnerChoiceCarDesc = {
  ...
  es: 'Alquila un coche y explora libremente',
...
window.ORT_I18N.partnerChoiceTransferDesc = {
  ...
  es: 'Conductor privado, precio fijo garantizado',
...
window.ORT_I18N.partnerRedirectCarText = {
  ...
  es: 'Te redirigimos a <strong>QEEQ.com</strong>, nuestro socio de confianza para alquiler de coches.<br><br>✅ Mejor precio garantizado<br>✅ Cancelación gratuita<br>✅ Servicio al cliente 24/7<br>✅ +7 millones de vehículos en 200 países',
...
window.ORT_I18N.partnerRedirectTransfersText = {
  ...
  es: 'Te redirigimos a <strong>KiwiTaxi</strong>, nuestro socio de confianza para traslados.<br><br>✅ Reserva rápida y fácil<br>✅ El conductor te espera a tu llegada<br>✅ Precio fijo, sin sorpresas<br>✅ Cancelación gratuita 24h antes',
...
window.ORT_I18N.partnerRedirectInsText = {
  ...
  es: 'Te redirigimos a <strong>Ekta Traveling</strong>, nuestro socio de seguros de viaje.<br><br>✅ Cobertura médica mundial<br>✅ Cancelación y equipaje<br>✅ Asistencia 24/7<br>✅ Presupuesto instantáneo',
...
// ═══════════════════════════════════════════════════════════════
window.ORT_I18N.builderImpossibleTitle = {
  fr: '⚠️ Itinéraire impossible',
  en: '⚠️ Impossible itinerary',
  es: '⚠️ Itinerario imposible',
...
window.ORT_I18N.builderImpossibleText = {
  ...
  es: 'Con los parámetros actuales, es imposible crear un itinerario entre <strong>{start}</strong> y <strong>{end}</strong>.',
...
window.ORT_I18N.builderAdjustParams = {
  ...
  es: 'Ajusta los parámetros a continuación:',
...
window.ORT_I18N.builderError = {
  ...
  es: 'Error al crear el itinerario',
...
window.ORT_I18N.unsavedToast = {
  ...
  es: '💡 Recuerda guardar los cambios con el botón 💾',
...
// ═══════════════════════════════════════════════════════════════
window.ORT_I18N.userPhotosResas = {
  fr: '📷 Photos et résas',
  en: '📷 Photos & bookings',
  es: '📷 Fotos y reservas',
...
window.ORT_I18N.userPhotosResasTooltip = {
  ...
  es: 'Añade tus propias fotos y reservas',
...
window.ORT_I18N.rateItinerary = {
  ...
  es: 'Calificar el itinerario de 1 a 10',
...
window.ORT_I18N.proposeOtherPlaces = {
  fr: 'Proposer d\'autres lieux',
  en: 'Propose other places',
  es: 'Proponer otros lugares',
...
window.ORT_I18N.writeSrcAdmin = {
  ...
  en: 'Write source (admin)',
  es: 'Escribir fuente (admin)',
...
window.ORT_I18N.delayCompensation = {
  ...
  en: 'Delay compensation',
  es: 'Compensación por retraso',
...
window.ORT_I18N.servicesPartnerTooltip = {
  ...
  en: 'Access to partner services',
  es: 'Acceso a servicios asociados',
...
window.ORT_I18N.suggestOtherPlaces = {
  fr: 'Proposer d\'autres lieux',
  en: 'Suggest other places',
  es: 'Sugerir otros lugares',
